...
io.on('connection', socket => {
    ...
    socket.on('joinRoom', ({ username, room }) => {
        ...
        socket.emit('message', formatMessage(botName, 'Welcome to chat', socket.id));
        ...
        socket.broadcast
            ...
            .emit(
                'message', 
                formatMessage(botName, `${user.username} has joined the chat`, socket.id)
        );
